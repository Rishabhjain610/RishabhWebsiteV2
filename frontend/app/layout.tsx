...
export const metadata: Metadata = {
  ...
  title: {
    default: "Rishabh Jain — Full Stack Developer & Agentic AI Builder",
    template: "%s | Rishabh Jain",
  },
  ...
  openGraph: {
    title: "Rishabh Jain — Full Stack Developer & Agentic AI Builder",
    description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Rishabh Jain — Full Stack Developer & Agentic AI Builder based in Mumbai",
        type: "image/png",
      },
    ],
    locale: "en_US",
