...
const experiences: Experience[] = [
  {
    ...
    current: true,
    bullets: [
      "Built backend and web portal for **48 stations** and **181 stalls** using **Node.js**, **Express.js**, **MongoDB Atlas**, and **Next.js**, developing **139 APIs** and **22 MongoDB models**.",
      "Engineered **CI/CD pipeline** automating code pulls, builds, and service restarts on production servers.",
      "Implemented bill workflow with **Puppeteer PDFs**, **skip/limit pagination**, and custom rates; cut electric bill generation time from **4 days to 3 hours**.",
      "Secured API with **JWT authentication (5 roles)**, NoSQL injection protection via **mongo-sanitize**, **10MB payload cap**, and **Helmet** headers.",
      "Automated compliance cycles using **node-cron with timezone support**, **Google Drive API** storage, and **Nodemailer OTP delivery**.",
  ...
  },
  {
    ...
    current: false,
    bullets: [
      "Engineered **GDG TSEC** and **HackSync 2.0** using **Next.js**, **Shadcn UI**, and **Framer Motion** to hit an **89+ Lighthouse score** and **99.9% uptime**, while leveraging **Vercel Analytics** and **Search Console** to track traffic and scale to **1,000+ registrations**.",
      ...
      "Mentored **50+** students across **Frontend**, **Backend**, and **AR** development, guiding teams on UI/UX best practices, API integration, and implementation strategies.",
      "Scaled event registrations to **700+** via strategic PR campaigns and secured technical sponsorships from **Devfolio** and **InterviewBuddy** (3 sponsors total).",
      "Earned **19 Google Cloud** skill badges and coached **30+** students through GCP learning paths and cloud infrastructure fundamentals.",
    ],
    certificates: [
  ...
  },
  {
    ...
    duration: "1 month",
    bullets: [
      "Engineered multi-outlet inventory & **sales analytics** system with **Excel upload** using **Next.js** & **Chart.js**, leading a team of 3.",
      "Built real-time database architecture with **Supabase** for live inventory tracking and responsive UI using **Tailwind CSS**; facilitated client communication for on-time delivery.",
  ...
  },
  {
    ...
    location: "Motihari, IN (Remote)",
    period: "Nov 2024 – Jan 2025",
    duration: "3 months",
    bullets: [
      "Built **10+ responsive pages** for freelance marketplace using **React.js**, **Material UI**, and **Framer Motion**.",
      "Coordinated with a 5-member team ensuring consistent UI/UX, on-schedule delivery, and **100+ monthly visitors**.",
      "Improved UI/UX and responsiveness, enhancing overall user engagement and web performance.",
      "Developed dynamic React.js components and collaborated with cross-functional teams for seamless UI integration.",
    ],
    certificates: [
