...
const bootLines = [
  ...
  { text: "    ✓ /work", color: "#3fb950", delay: 3500 },
  { text: "    ✓ /projects", color: "#3fb950", delay: 3700 },
...
const commands: Record<string, { output: string[]; navigate?: string }> = {
  ...
  resume: {
    ...
    navigate:
      "https://drive.google.com/file/d/1DV-irLeae0jWaRLNNyeMvwzPm8aqvXoB/view",
  },
  github: {
  ...
  instagram: {
    ...
    navigate: "https://instagram.com/rishabh_jain610",
  },
};
    ...
    if (match) {
      ...
      if (match.navigate) {
        setTimeout(() => {
          ...
          } else if (match.navigate!.startsWith("#")) {
            // Anchor link - scroll to element
            document
              .querySelector(match.navigate!)
              ?.scrollIntoView({ behavior: "smooth" });
          } else {
            // File path - open/download
            window.open(match.navigate!, "_blank");
          }
        }, 400);
      }
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 max-w-lg w-full space-y-4 relative z-10 text-center lg:text-left">
        ...
        {/* typewriter */}
        <div className="h-8 flex items-center justify-center lg:justify-start relative">
          {/* Static invisible text — reserves space for LCP + prevents CLS */}
          ...
          <span className="absolute inset-0 flex items-center justify-center lg:justify-start">
            <span
              className="text-2xl md:text-4xl font-semibold font-spaceGrotesk"
              style={{ color: "#4A90E2" }}
            >
              <TypeAnimation
                sequence={[
          ...
          <a
            ...
            onMouseEnter={(e) => {
              (e.currentTarget as HTMLElement).style.boxShadow =
                "0 10px 28px rgba(74,144,226,0.5)";
